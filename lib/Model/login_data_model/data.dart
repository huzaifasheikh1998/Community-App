...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        userProfile: json['user_profile'] as dynamic,
        fullName: json['full_name'] as String?,
        userType: json['user_type'] as String?,
        ownerCnic: json['owner_cnic'] as String?,
        tenantCnic: json['tenant_cnic'] as String?,
        unitNo: json['unit_no'] as dynamic,
        houseCategory: json['house_category'] as dynamic,
        contact: json['contact'] as String?,
        address: json['address'] as int?,
        balance: json['balance'] as dynamic,
        tankerLeft: json['tanker_left'] as dynamic,
        ...
        addressRelation: json['AddressRelation'] == null
            ? null
            : AddressRelation.fromJson(
                json['AddressRelation'] as Map<String, dynamic>),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        'qr_code': qrCode,
        'token': token,
        'AddressRelation': addressRelation?.toJson(),
      };
